...
var builder = createBuilder.call(this, data);var a,b,div,i,p,q,s,th,u;a = function(){return builder.tag('a', arguments);};b = function(){return builder.tag('b', arguments);};div = function(){return builder.tag('div', arguments);};i = function(){return builder.tag('i', arguments);};p = function(){return builder.tag('p', arguments);};q = function(){return builder.tag('q', arguments);};s = function(){return builder.tag('s', arguments);};th = function(){return builder.tag('th', arguments);};u = function(){return builder.tag('u', arguments);};(function(){
div(function() {
  return p(function() {
