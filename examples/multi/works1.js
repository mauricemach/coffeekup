(function(){ 
    ...
    this.templates["template"] = function anonymous(data) {
        var builder = templ.call(this, data);
        var a,i,li,p,s,th,u,ul;
        a = function(){return builder.tag('a', arguments);};
        i = function(){return builder.tag('i', arguments);};
        li = function(){return builder.tag('li', arguments);};
        p = function(){return builder.tag('p', arguments);};
        s = function(){return builder.tag('s', arguments);};
        th = function(){return builder.tag('th', arguments);};
        u = function(){return builder.tag('u', arguments);};
        ul = function(){return builder.tag('ul', arguments);};
        (function(){
            ul(function() {
